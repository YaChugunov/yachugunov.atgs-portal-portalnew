...
<div class="container d-flex flex-column">
    ...
    <div id="portalnew-main-center-icons" class="d-flex flex-row justify-content-between py-3">
        <div class="service-item d-flex flex-column">
            <div class="service-icon px-5 pt-2 pb-1">
                <a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/sp/index.php?type=contragents&mode=main">
                    <img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/sp/_assets/images/favicons/favicon.ico" alt=""
                         width="64" height="64" class="d-inline-block align-text-middle">
                </a>
            </div>
        ...
        <div class="service-item d-flex flex-column">
            <div class="service-icon px-5 pt-2 pb-1">
                <a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mailnew/index.php?type=main">
                    <img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mailnew/_assets/images/favicons/favicon.ico"
                         alt="" width="64" height="64" class="d-inline-block align-text-middle">
                </a>
            </div>
        ...
        <div class="service-item d-flex flex-column">
            <div id="portalCloudFiles-button" class="service-icon px-5 pt-2 pb-1">
                <img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portalnew/php/examples/simple/main/cloudFiles/favicon.ico"
                     alt="" width="64" height="64" class="d-inline-block align-text-middle">
            </div>
            <div class="service-title text-center">Облако</div>
        </div>
        <div class="service-item inactive d-flex flex-column" data-toggle="popover"
             data-content="1-я очередь (3-4 квартал, 2024)">
            <div class="service-icon px-5 pt-2 pb-1">
                <img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portalnew/_assets/images/service-icons/icon-serviceLocked.svg"
                     alt="" width="64" height="64" class="d-inline-block align-text-middle">
            </div>
        ...
        <div class="service-item inactive d-flex flex-column" data-toggle="popover"
             data-content="2-я очередь (2-3 квартал, 2024)">
            <div class="service-icon px-5 pt-2 pb-1">
                <img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portalnew/_assets/images/service-icons/icon-serviceLocked.svg"
                     alt="" width="64" height="64" class="d-inline-block align-text-middle">
            </div>
        ...
        <div class="service-item inactive d-flex flex-column" data-toggle="popover"
             data-content="2-я очередь (1-2 квартал, 2025)">
            <div class=" service-icon px-5 pt-2 pb-1">
                <img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portalnew/_assets/images/service-icons/icon-serviceLocked.svg"
                     alt="" width="64" height="64" class="d-inline-block align-text-middle">
            </div>
        ...
        <div class="service-item inactive d-flex flex-column" data-toggle="popover"
             data-content="3-я очередь (3-4 квартал, 2024)">
            <div class=" service-icon px-5 pt-2 pb-1">
                <img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portalnew/_assets/images/service-icons/icon-serviceLocked.svg"
                     alt="" width="64" height="64" class="d-inline-block align-text-middle">
            </div>
    ...
    <div class="d-flex flex-column">
        <div class="main-input hint" style="">Для поиска сотрудников в начале запроса
            вводим @</div>
        <div id="portalnew-main-input" class="d-flex flex-row input-inactive-border search_box">
            <input id="main-input" class="main-input form-control form-control-lg" type="text"
                   placeholder="Тыкайте сюда, не бойтесь">
            <div class="d-flex align-self-center py-3 px-1" data-toggle="popover"
                 data-content='<div class="text-center">Очистить поле поискового запроса.</div>'><i
                   id="searchInput-clear" class="fa-solid fa-xmark fa-2xl mx-2 align-self-center text-secondary"></i>
            </div>
            <div class="d-flex align-self-center py-3 px-1" data-toggle="popover"
                 data-content='<div class="text-center">Настройка текущего поиска. Можно выбрать поиск как по всем разделам Портала, так и по какому-то отдельному.</div>'>
                <i id="searchInput-settings" class="fa-solid fa-gear fa-2xl mx-2 align-self-center text-secondary"></i>
            </div>
            <div class="d-flex align-self-center py-3 px-1" data-toggle="popover"
                 data-content='<div class="text-center">Нажмите, если хотите узнать как работает посик по сервисам Портала и как им правильно пользоваться.</div>'>
                <i id="searchInput-help"
                   class="fa-solid fa-question fa-2xl ml-2 mr-3 align-self-center text-secondary"></i>
            </div>
        </div>
...
$(window).on("load", function() {
    ...
    $('#main-input').keyup(delay(function(e) {
        $('#search_box-result [data-toggle="tooltip"]').tooltip("hide");
        var query = $(this).val();
        $('#searchInput-help').removeClass('fa-bounce');
            ...
            if ((search != '') && (search.length > 1)) {
                $.ajax({
                    ...
                    success: function(msg) {
                        ...
                        if (msg != '') {
                            $result.fadeIn();
                            $('#search_box-result [data-toggle="tooltip"]').tooltip({
                                html: true,
                                trigger: 'hover',
                                placement: 'auto',
                            });
