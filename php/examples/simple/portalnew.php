<script type="text/javascript" language="javascript" class="init"
        src="http://<?php echo $_SERVER['HTTP_HOST'] . __SERVICENAME_PORTALNEW . __PORTAL_MAIN_MAIN_WORKPATH; ?>/js/userSettings-control.js">
</script>
<script type="text/javascript" language="javascript" class="init"
        src="http://<?php echo $_SERVER['HTTP_HOST'] . __SERVICENAME_PORTALNEW . __PORTAL_MAIN_MAIN_WORKPATH; ?>/js/userMessages-control.js">
</script>

<link href="http://<?php echo $_SERVER['HTTP_HOST'] . __SERVICENAME_PORTALNEW; ?>/_assets/css/portalnew.css"
      rel="stylesheet">
<link href="http://<?php echo $_SERVER['HTTP_HOST'] . __SERVICENAME_PORTALNEW; ?>/_assets/css/messages-list.css"
      rel="stylesheet">
<link href="http://<?php echo $_SERVER['HTTP_HOST'] . __SERVICENAME_PORTALNEW; ?>/_assets/css/messages-push.css"
      rel="stylesheet">
...
<div aria-live="polite" aria-atomic="true" class="toasts-block position-fixed"
     style="z-index:9; opacity:1; top:110px; left:0">
    <!-- Разместите его:
    ...
    <div class="p-3">
        ...
        <div id="portalnew-toast-1" class="d-none">
            <div class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-toast-id=""
                 data-autohide="false">
                <div class="toast-header">
                    <strong class="mr-auto">
                        <div class="header-text"></div>
                    </strong>
                    <button type="button" class="close" data-dismiss="toast"><span
                              class="text-white small">x</span></button>
                </div>
...
<!-- Modal -->
<div class="modal fade" id="searchingOutput-modal" data-keyboard="false" tabindex="-1"
...
<div class="modal fade" id="loadedData-help-modal" data-keyboard="false" tabindex="-1"
     aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="searchingSettings-modal" data-keyboard="false" tabindex="-1"
     aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div id="searchingSettings-block" class="mb-4">
                    <div class="custom-control custom-switch mb-3">
                        <input type="checkbox" class="custom-control-input" id="searchSwitch-mail"
                               data-dbfield="enable_searchingMail" value="">
                        <label class="custom-control-label" for="searchSwitch-mail">Искать в
                            Почте<span id="mail_userRestr" class="ml-2"></span></label>
                    </div>
                    <div class="custom-control custom-switch mb-3">
                        <input type="checkbox" class="custom-control-input" id="searchSwitch-dog"
                               data-dbfield="enable_searchingDog" value="">
                        <label class="custom-control-label" for="searchSwitch-dog">Искать в
                            Договоре, включая
                            этапы<span id="dog_userRestr" class="ml-2"></span></label>
                    </div>
                    <div class="custom-control custom-switch mb-3">
                        <input type="checkbox" class="custom-control-input" disabled id="searchSwitch-sp"
                               data-dbfield="enable_searchingSP" value="">
                        <label class="custom-control-label" for="searchSwitch-sp">Искать в
                            Справочнике (скоро)</label>
                    </div>
                    <div class="custom-control custom-switch mb-3">
                        <input type="checkbox" class="custom-control-input" disabled id="searchSwitch-hr"
                               data-dbfield="enable_searchingHR" value="">
                        <label class="custom-control-label" for="searchSwitch-hr">Искать в Кадрах
                            (скоро)</label>
                    </div>
                    <div class="custom-control custom-switch mb-3">
                        <input type="checkbox" class="custom-control-input" disabled id="searchSwitch-ism"
                               data-dbfield="enable_searchingISM" value="">
...
<div class="modal fade" id="userSettings-modal" data-keyboard="false" data-backdrop="true" tabindex="-1"
     aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div id="userSettings-block" class="mb-4" style="">
                    <div class="custom-control custom-switch mb-3" style="">
                        <input type="checkbox" class="custom-control-input" id="userSettingsSwitch-usePush"
                               data-dbfield="use_pushMessages" value="">
                        <label class="custom-control-label" for="userSettingsSwitch-usePush">Разрешить
                            push-уведомления</label>
                    </div>
                    <div class="custom-control custom-switch mb-3" style="">
                        <input type="checkbox" class="custom-control-input" id="userSettingsSwitch-showTopblock"
                               data-dbfield="mainPageUI_showTopblock" value="">
                        <label class="custom-control-label" for="userSettingsSwitch-showTopblock">Показывать верхний
                            блок</label>
                    </div>
                    <div class="custom-control custom-switch mb-3" style="">
                        <input type="checkbox" class="custom-control-input" id="userSettingsSwitch-showLeftBottomblock"
                               data-dbfield="mainPageUI_showLeftBottomblock" value="">
                        <label class="custom-control-label" for="userSettingsSwitch-showLeftBottomblock">Показывать блок
                            слева от "Все сервисы"</label>
                    </div>
                    <div class="custom-control custom-switch mb-3" style="">
                        <input type="checkbox" class="custom-control-input" id="userSettingsSwitch-showRightBottomblock"
                               data-dbfield="mainPageUI_showRightBottomblock" value="">
                        <label class="custom-control-label" for="userSettingsSwitch-showRightBottomblock">Показывать
                            блок справа от "Все сервисы"</label>
                    </div>
                    <div class="custom-control custom-switch mb-3" style="">
                        <input type="checkbox" class="custom-control-input" id="userSettingsSwitch-showCloudblock"
                               data-dbfield="mainPageUI_showCloudblock" value="">
                    ...
                    <div class="custom-control custom-switch" style="">
                        <input type="checkbox" class="custom-control-input" id="userSettingsSwitch-useLightTheme"
                               data-dbfield="use_lightTheme">
...
<div class="modal fade" id="ListMessages-modal" data-keyboard="false" data-backdrop="true" tabindex="-1"
     aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable fixed-top"
         style="margin-right:-0.5rem !important; margin-top:0.5rem !important; max-height: calc(100% - 1rem) !important">
...
<div class="modal fade" id="portalCloud-listFiles-modal" data-keyboard="false" tabindex="-1"
     aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-body">
                <table id="table-portalCloudFiles" class="table table-borderless table-striped mb-3" cellspacing="0"
                       width="100%">
...
<div class="modal fade" id="modal-alarmMessage" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog"
     aria-labelledby="modal-alarmMessage-label" aria-hidden="true">
...
<div class="modal fade" id="modal-spTel" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog"
     aria-labelledby="modal-spTel-label" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content shadow border-0 bg-white text-dark" style="font-family:'Stolzl Book',sans-serif">
            <div class="modal-body pb-0">
                <div class="container-fluid">
...
<div class="modal fade" id="modal-workStatus" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog"
     aria-labelledby="modal-workStatus-label" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content shadow border-0 bg-white text-dark" style="font-family:'Stolzl Book',sans-serif">
            <div class="modal-header">
                <h5 class="modal-title">Рабочий статус</h5>
                    ...
                    <form>
                        <div class="form-group d-flex">
                            <div class="mr-2" style="width:35%">
                                <label for="workStatus-reportType">Статус</label>
                                <select class="form-control" id="workStatus-reportType" name="reportType">
                                    <option>---</option>
                                    <option value="5">Работаю дистанционно</option>
                                    <option value="1">Буду отсутствовать</option>
                                    <option value="2">В отпуске</option>
                                    <option value="3">На больничном</option>
                                    <option value="4">В командировке</option>
                                </select>
                            </div>
                            <div class="mr-2" style="width:25%">
                                <label for="workStatus-reportOption">Что по датам</label>
                                <select class="form-control" id="workStatus-reportOption" name="reportOption">
                                    <option value="1">Сегодня</option>
                                    <option value="2">Завтра</option>
                                    <option value="3">С ... и далее</option>
                                    <option value="4">С ... по ...</option>
                                </select>
                            </div>
                            <div class="mr-2" style="width:20%">
                                <label for="workStatus-dateFrom">Дата (с)</label>
                                <input type="date" class="form-control" id="workStatus-dateFrom" name="dateFrom">
                            </div>
                            <div class="" style="width:20%">
                                <label for="workStatus-dateTo">По</label>
                                <input type="date" class="form-control" id="workStatus-dateTo" name="dateTo">
                            </div>
                            <div class="" style="">
                                <input type="hidden" class="form-control" id="workStatus-reportID" name="reportID">
                                <input type="hidden" class="form-control" id="workStatus-userID" name="userID">
                                <input type="hidden" class="form-control" id="workStatus-action" name="action">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="workStatus-comment">Комментарий к статусу</label>
                            <textarea class="form-control" id="workStatus-comment" rows="2" name="comment"></textarea>
                        </div>
                    </form>
            ...
            <div class="modal-footer justify-content-center border-top-0 pt-0">
                <button type="button" class="delete btn btn-danger text-white btn-sm" data-dismiss="modal">Удалить
                    статус</button>
                <button type="button" class="save btn btn-dark text-white btn-sm"
...
//
//
$("#portalmain-workStatus").on("mouseenter", function() {
    console.log("#portalmain-workStatus", "mouseenter");
    $("#portalmain-workStatus .workstatus-btn").fadeIn(250);
});
$("#portalmain-workStatus").on("mouseleave", function() {
    console.log("#portalmain-workStatus", "mouseleave");
    $("#portalmain-workStatus .workstatus-btn").fadeOut(250);
});
//
//
$("#modal-workStatus button.delete").on("click", function() {
    reportid = $('#modal-workStatus input[name="reportID"]').val();
    result = ajaxRequest_getWorkStatusDelete(reportid);
    checkVal(result) ? ajaxRequest_getWorkStatus('currentAbsence') : '';
});
$("#modal-workStatus button.save").on("click", function() {
    userid = $('#modal-workStatus *[name="userID"]').val();
    action = $('#modal-workStatus *[name="action"]').val();
    reportid = $('#modal-workStatus *[name="reportID"]').val();
    reporttype = $('#modal-workStatus *[name="reportType"]').val();
    reportoption = $('#modal-workStatus *[name="reportOption"]').val();

    datefrom = moment($('#modal-workStatus *[name="dateFrom"]').val(), "YYYY-MM-DD").format("YYYY-MM-DD");
    dateto = moment($('#modal-workStatus *[name="dateTo"]').val(), "YYYY-MM-DD").format("YYYY-MM-DD");

    comment = $('#modal-workStatus *[name="comment"]').val();
    result = ajaxRequest_getWorkStatusSave(userid, action, reportid, reporttype, reportoption, datefrom, dateto,
        comment);
    checkVal(result) ? ajaxRequest_getWorkStatus('currentAbsence') : '';
});
//
//
$('#portalmain-workStatus .enlarge').on("click", function() {
    console.log("#portalmain-workStatus .enlarge", "clicked");
    if ($(this).hasClass("on")) {
        console.log("#portalmain-workStatus .enlarge", "clicked", "has ON");
        $(this).removeClass("on");
        $('#portalmain-blocks').fadeOut('slow', function() {
            // Animation complete
            $('#portalmain-staffAbsence .staffAbsence-out').removeClass("flex-row").addClass(
                "flex-column");
            $('#portalnew-main-top-blocks .box-3').css({
                "width": "33%"
            });
            $('#portalmain-staffAbsence .reportStatus').css({
                "width": "100%",
                "margin-left": "0",
                "margin-right": "0"
            });
            $('#portalmain-workStatus .enlarged-state-msg').html('');
            $('#portalnew-main-top-blocks .box-1, #portalnew-main-top-blocks .box-2').show();
        });
        $('#portalmain-blocks').fadeIn(200, function() {
            $('#portalmain-workStatus .workstatus-btn.btn3 i').removeClass("fa-compress").addClass(
                "fa-expand");
        });
    } else {
        console.log("#portalmain-workStatus .enlarge", "clicked", "has not ON");
        $(this).addClass("on");
        $('#portalmain-blocks').fadeOut('slow', function() {
            // Animation complete
            $('#portalnew-main-top-blocks .box-1, #portalnew-main-top-blocks .box-2').hide();
            $('#portalnew-main-top-blocks .box-3').css({
                "width": "100%"
            });
            $('#portalmain-staffAbsence .staffAbsence-out').removeClass("flex-column").addClass(
                "flex-row");
            $('#portalmain-staffAbsence .staffAbsence-out').css({
                "flex-wrap": "wrap",
        ...
        $('#portalmain-blocks').fadeIn(200, function() {
            $('#portalmain-workStatus .workstatus-btn.btn3 i').removeClass("fa-expand").addClass(
                "fa-compress");
        });
    }
});
