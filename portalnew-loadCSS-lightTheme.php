...
<link href="http://<?php echo $_SERVER['HTTP_HOST'] . __SERVICENAME_PORTALNEW; ?>/_assets/css/modals.css"
      rel="stylesheet">
<link href="http://<?php echo $_SERVER['HTTP_HOST'] . __SERVICENAME_PORTALNEW; ?>/_assets/css/searching-main.css"
      rel="stylesheet">
<style>
...
#portalmain-workStatus .reportStatus:hover .control-btn:hover {
