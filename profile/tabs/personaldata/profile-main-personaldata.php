...
function ajaxRequest_loadProfileData(data, responseHandler) {
    ...
    request_loadProfileData.done(function(response_loadProfileData, textStatus, jqXHR) {
        ...
        if (response_loadProfileData != "-1") {
            ...
            hr_office = checkVal(hr_office) ? hr_office : "";
            hr_mainoffice = checkVal(hr_mainoffice) ? hr_mainoffice : "";
            let bull = (checkVal(hr_office) && checkVal(hr_mainoffice)) ? "&nbsp;&bull;&nbsp;" : "";
            let office = hr_mainoffice + bull + hr_office;
            (hr_office !== "" || hr_mainoffice !== "") ? $(
...
<div class="row gx-5">
                ...
                <div class="col-md-12">
                    <div class="card-header">
                        ...
                        <div class="input-group">
                            <span><a id="profile-userid-a" href="#" class="link-primary">profile/?userid=<span
                                          id="profile-userid"></span></a></span>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-md-5">
        ...
        <div class="input-group mb-3">
            <input id="profile-login" type="text" class="form-control" placeholder="Логин" aria-label="Логин"
                   aria-describedby="profile-login">
        </div>
        <label for="dinner-login">Ваш логин в dinner.atgs.ru</label>
        <div class="input-group mb-3">
            <input id="dinner-login" type="text" class="form-control" placeholder="Логин" aria-label="Логин"
                   aria-describedby="dinner-login">
        </div>
        ...
        <div class="input-group">
            <input id="profile-password" type="password" class="form-control" placeholder="Новый пароль"
                   aria-label="Новый пароль" aria-describedby="profile-password" disabled="disabled">
        </div>
        <div class="d-flex flex-row bd-highlight" id="dinner-mailenbl-block">
            <div class="p-2 bd-highlight align-self-center">
                <div class="form-check form-switch">
                    <input class="form-check-input" id="profile-password-enbl" type="checkbox"
                           name="profile-password-enbl">
...
<div class="row gx-5" style="margin-top: 2.0rem">
    ...
    <div class="col-md-4 block-view">
        ...
        <div class="input-group mb-3">
            <input id="dinner-email" type="text" class="form-control" placeholder="name@example.com"
                   data-inputmask="'alias': 'email'" aria-describedby="dinner-email">
        </div>
    ...
    <div class="col-md-4">
        ...
        <div class="input-group mb-3">
            <input id="profile-worktel" type="tel" class="form-control" pattern="[0-9]{3}" placeholder=""
                   data-inputmask="'mask': '999'" aria-describedby="profile-worktel">
        </div>
        <label for="profile-workdoptel">Внутренний номер (доп)</label>
        <div class="input-group mb-3">
            <input id="profile-workdoptel" type="tel" class="form-control" pattern="[0-9]{3}" placeholder=""
                   data-inputmask="'mask': '999'" aria-describedby="profile-workdoptel">
        </div>
        <label for="profile-emailcorp">Корпоративный email</label>
        <div class="input-group mb-3">
            <input id="profile-emailcorp" type="text" class="form-control" placeholder="name@atgs.ru"
                   data-inputmask="'alias': 'email'" aria-describedby="profile-emailcorp">
        </div>
    </div>
    <div class="col-md-4">
        ...
        <div class="input-group mb-3">
            <input id="profile-tel" type="tel" class="form-control" pattern="{1}[0-9]{1,3} [0-9]{11,14}" placeholder=""
                   data-inputmask="'mask': '8 (999) 9999999'" aria-describedby="profile-tel">
        </div>

        <label for="profile-emaildop">Дополнительный email</label>
        <div class="input-group mb-3">
            <input id="profile-emaildop" type="text" class="form-control" placeholder="name@example.com"
                   data-inputmask="'alias': 'email'" aria-describedby="profile-emaildop">
        </div>
        <h3 class="mb-3 title">Контакты в сервисе Кадры</h3>
        <label for="profile-telhr">Контактный телефон</label>
        <div class="input-group mb-3">
            <input id="profile-telhr" type="tel" class="form-control" pattern="{1}[0-9]{1,3} [0-9]{11,14}"
                   placeholder="" data-inputmask="'mask': '8 (999) 9999999'" aria-describedby="profile-telhr">
        </div>

        <label for="profile-emailhr">Контактный email</label>
        <div class="input-group mb-3">
            <input id="profile-emailhr" type="text" class="form-control" placeholder="name@example.com"
                   data-inputmask="'alias': 'email'" aria-describedby="profile-emailhr">
        </div>
    </div>
</div>
<div class="row">
