                ...
                <div class="d-flex flex-row">
                    <div class="d-flex flex-column mr-5">
                        ...
                        <p class="section-text"><a
                               href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portalnew/index.php"
                               title="Портал 2023 / Главная страница">Портал</a></p>
                        <p class="section-text"><a
                        ...
                        <p class="section-text"><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet"
                               title="Сервис Договор">Договор</a></p>
                        <p class="section-text"><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/hr"
                               title="Сервис Кадры">Кадры</a></p>
                        <p class="section-text"><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/ism"
                               title="Сервис ИСМ/СМК">ИСМ/СМК</a></p>
                        <p class="section-text"><a
                               href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mailATC/incoming.php?mode=thisyear"
                               title="Входящая почта АТ Система">Входящая АТ Система</a></p>
                        <p class="section-text"><a
                               href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mailATC/outgoing.php?mode=thisyear"
                               title="Исходящая почта АТ Система">Исходящая АТ Система</a></p>
                    </div>
                    <div class="d-flex flex-column mr-5">
                        <h3 class="section-title mb-3">Разделы</h3>
                        <p class="section-text"><a
                               href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-blankview.php?blankview_type=current"
                               title="Бланки заявок на новый договор">Бланки заявок на новый договор</a></p>
                        <p class="section-text"><a
                               href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-zayvview.php?zayvview_type=current"
                               title="Заявки ИТиТО АСУ">Заявки ИТиТО АСУ</a></p>
                        <p class="section-text"><a
                               href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-report.php"
                               title="Отчёты сервиса Договор">Отчёты сервиса Договор</a></p>
                        <p class="section-text"><a
                               href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-base.php?section=missions"
                               title="Реестр договоров (для служебных заданий)">Реестр договоров (для сл. заданий)</a>
                        </p>
                        <h3 class="section-title mt-3 mb-3">Ссылки</h3>
                        <p class="section-text"><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/eda"
                               title="Заказать обед в разделе Еда 2.0 на Портале">Еда 2.0 (Портал)</a></p>
                        <p class="section-text"><a href="http://dinner.atgs.ru"
                               title="Заказать обед на сайте dinner.atgs.ru" target="_blank">Еда (dinner.atgs.ru)</a>
                        </p>
            ...
            <div class="col text-right">
                <div class="d-flex flex-row justify-content-end">
                    <div class="d-flex flex-column mr-5">
                        ...
                        <p class="section-text"><span id="searchInput-help-footer" class="footer-wiki-link">Что
                                такое
                                Поиск 1.0</span></p>
                        <p class="section-text"><span id="messages-help-footer" class="footer-wiki-link">Что такое
                                уведомления пользователя</span></p>
                        <p class=" section-text"><span id="cloudFiles-help-footer" class="footer-wiki-link">Что
                                такое
                                Облако</span></p>
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex flex-row justify-content-end mt-1">
                            <a href="https://vk.com/atgsportal" target="_blank"><img
                                     src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portalnew/_assets/images/socials-logo/vk-logo-blue_120x120.svg"
                                     width="32" class="mr-1 rounded-circle"></a>
                            <a href="https://t.me/+YoT9ueBKP21hYjhi" target="_blank"><img
                                     src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portalnew/_assets/images/socials-logo/telegram-logo.svg"
                                     width="32" class="ml-1 arounded-circle"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $('#loadedData-help-output').load(
            ...
            function() {
                $('#loadedData-help-modal h5.modal-title').html(
                    "Инструмент глобального поиска Портала - Поиск 1.1");
