...
# Загружаем общие администарторские установки
    $qryAdminSettings = $mysqli->query("SELECT * FROM admin_settings WHERE 1 ORDER BY id DESC LIMIT 1");
    $rowAdminSettings = $qryAdminSettings->fetch_array(MYSQLI_ASSOC);
    define('__ADMSETTINGS_MSG_SHOW', $rowAdminSettings['staticMsgOnMainPage_show']);
    define('__ADMSETTINGS_MSG_TEST', $rowAdminSettings['staticMsgOnMainPage_test']);
    define('__ADMSETTINGS_MSG_TEXT', $rowAdminSettings['staticMsgOnMainPage_text']);
...
##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### #####
#
define('__STARTUPMODAL_MSGID', '202412-01');
define('__NY_STYLE', FALSE);
#
if (!isset($_IS_CRONTAB)) {
